        ...
        <div v-if="true" class="sidebar-list">
          <nuxt-link :to="'/'">
            ...
            >
              ...
              <span class="sidebar-text is-menu">Products</span>
              <div class="sidebar-tooltip">
                <span class="sidebar-text is-tooltip">Products</span>
              </div>
            </div>
          </nuxt-link>
        </div>
        <div  class="sidebar-list">
          <nuxt-link :to="'/'">
            ...
            >
              ...
              <span class="sidebar-text is-menu">Categories</span>
              <div class="sidebar-tooltip">
                <span class="sidebar-text is-tooltip">Categories</span>
              </div>
            </div>
          </nuxt-link>
        </div>
        <div  class="sidebar-list">
          <nuxt-link :to="'/'">
            ...
            >
              ...
              <span class="sidebar-text is-menu">Users</span>
              <div class="sidebar-tooltip">
                <span class="sidebar-text is-tooltip">Users</span>
              </div>
            </div>
          </nuxt-link>
        </div>
